...
- **練習ループ** — 意識ポイント（1〜3個・プリセット付き）、セッション（プロセス目標→振り返り、戦績を自動紐づけ）、ティルト検知→休憩提案。エビデンスは[ライブラリ記事](docs/05_practice-science.md)準拠
- **自キャラメモ** — 立ち回り / 技別 / 試合、タブ整理
- **横断検索** — キャラ名 / 技名 / メモ本文
- **ライブラリ（公開記事）** — 練習科学・調査ノートを認証不要で閲覧
- **AI試合レビュー**（YouTube+タイムスタンプ→Claude Codeが場面分析）、**外部情報収集**（予定）
